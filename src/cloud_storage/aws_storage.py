    ...
    def upload_file(self,from_filename:str, to_filename:str,bucket_name:str,remove:bool = True):
        ...
        try:
            ...
            if remove:
                ...
                logging.info(f"Removed local file {from_filename} from upload")
            logging.info("Exited the upload file method from SimpleStorageService class")
        except Exception as e:
            raise MyException(e,sys) from e
    def upload_df_to_csv(self,data_frame:DataFrame,local_filename:str,bucket_filename:str,bucket_name:str)->None:
        logging.info("Entered the upload_df_as_csv method of SimpleStorageService class")
        try:
            data_frame.to_csv(local_filename,index=True,header= True)
            self.upload_file(local_filename,bucket_filename,bucket_name)
            logging.info("Exited the upload_df_as_csv method of SimpleStorageClass")
        except Exception as e:
            raise MyException(e,sys) from e
