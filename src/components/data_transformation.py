...
class DataTransformation:
    ...
    def initiate_data_transformation(self) ->DataTransformationArtifact:
            try:
                ...
                logging.info("Input and target columns are defined for both trained and test data")
                ...
                logging.info("Column Transformations are applied to train and test data")
